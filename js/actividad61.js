  function Inicio() {
    ...
    var valoresA = [];
    var valoresB = [];
    var letras = ["a","n","m","x","y","z","c","d"];
    var pos =  Math.round(Math.random() * (7 - 0) + 0);  
    for(var i=0; i<=12; i++){
    ...
    //casoC
    var cad5= '(<label id="valorA'+4+'">'+letras[pos]+'</label>)'+
    ...
    for(var i=0; i<=12; i++){
      if(i==0)
      $("#contenido1").append('<br>'+cad1+'&nbsp; =&nbsp; <input type="number"  style="text-align: center;width:45px;height:20px; font-size: 12px" id="res'+i+'"><SUP><input type="number" placeholder=0 style="text-align: center;width:35px;height:20px; font-size: 12px" id="rE'+i+'"></SUP><br>');
      else if(i==1)
      $("#contenido1").append('<br>'+cad3+'&nbsp; =&nbsp; <input type="number"  style="text-align: center;width:45px;height:20px; font-size: 12px" id="res'+i+'"><SUP><input type="number" placeholder=0  style="text-align: center;width:35px;height:20px; font-size: 12px" id="rE'+i+'"></SUP><br>');
      else if(i==2)
      $("#contenido1").append('<br>'+cad5+'&nbsp; =&nbsp; <input type="text"  style="text-align: center;width:45px;height:20px; font-size: 12px" id="res'+i+'"><SUP><input type="number" placeholder=0  style="text-align: center;width:35px;height:20px; font-size: 12px" id="rE'+i+'"></SUP><br>');
      else if(i==3)
      $("#contenido").append('<br>'+cad6+'&nbsp; =&nbsp; <input type="text"  style="text-align: center;width:45px;height:20px; font-size: 12px" id="res'+i+'"><SUP><input type="number" min="0" placeholder=0 style="text-align: center;width:35px;height:20px; font-size: 12px" id="rE'+i+'"></SUP><br>');
      else if(i==4)
      $("#contenido").append('<br>'+cad7+'&nbsp; =&nbsp; <input type="text"  style="text-align: center;width:45px;height:20px; font-size: 12px" id="res'+i+'"><SUP><input type="number" min="0" placeholder=0 style="text-align: center;width:35px;height:20px; font-size: 12px" id="rE'+i+'"></SUP><br>');  
    }        
  };
  function Cargar(){
   $('#contenido1').html('');
