    ...
    return function t(e, n, i) {
        ...
        1: [function(t, e, n) {
            ...
            function i(t, e) {
                ...
                for (var o = r.bind(e), s = 0; s < n.length; s++)
                    if (!o(n[s]) || t[n[s]] !== e[n[s]]) return !1;
                return !0
            }
        ...
        4: [function(t, e, n) {
            ...
            function i(t, e, n) { return !r(t.props, e) || !r(t.state, n) }
            var r = t("fbjs/lib/shallowEqual");
            e.exports = i
        ...
        5: [function(t, e, n) {
            ...
            a = t("./actions"), h = t("./bindEvents"), c = t("./math"), u = t("./shapes"), l = u.createShape, m = u.shapeToJSON, r = u.JSONToShape, p = t("./canvasRenderer").renderShapeToContext, d = t("./svgRenderer").renderShapeToSVG, f = t("./renderSnapshotToImage"), g = t("./renderSnapshotToSVG"), s = t("../tools/Pencil"), y = t("./util"), i = "infinite", e.exports = o = function() {
                ...
                return t.prototype.bindToElement = function(t) { var e, n; return this.containerEl ? void console.warn("Trying to bind Literally Canvas to a DOM element more than once is unsupported.") : (this.containerEl = t, this._unsubscribeEvents = h(this, this.containerEl, this.opts.keyboardShortcuts), this.containerEl.style["background-color"] = this.colors.background, this.containerEl.appendChild(this.backgroundCanvas), this.containerEl.appendChild(this.canvas), this.isBound = !0, n = function(t) { return function() { return t.keepPanInImageBounds(), t.repaintAllLayers() } }(this), this.respondToSizeChange = y.matchElementSize(this.containerEl, [this.backgroundCanvas, this.canvas], this.backingScale, n), this.watermarkImage && (this.watermarkImage.onload = function(t) { return function() { return t.repaintLayer("background") } }(this)), null != (e = this.tool) && e.didBecomeActive(this), n()) }, t.prototype._teardown = function() { var t; return null != (t = this.tool) && t.willBecomeInactive(this), "function" == typeof this._unsubscribeEvents && this._unsubscribeEvents(), this.tool = null, this.containerEl = null, this.isBound = !1 }, t.prototype.trigger = function(t, e) { return this.canvas.dispatchEvent(new CustomEvent(t, { detail: e })), null }, t.prototype.on = function(t, e) {
                    var n;
                    return n = function(t) { return e(t.detail) }, this.canvas.addEventListener(t, n),
                    ...
                    var n;
                    if (null == e && (e = "main" === t), this.isBound) {
                        switch (t) {
                            case "background":
                                this.backgroundCtx.clearRect(0, 0, this.backgroundCanvas.width, this.backgroundCanvas.height), n = function(t) { return function() { return t.repaintLayer("background") } }(this), this.watermarkImage && this._renderWatermark(this.backgroundCtx, !0, n), this.draw(this.backgroundShapes, this.backgroundCtx, n);
                                break;
                            case "main":
                    ...
                    var t, e, n, r, o, s, a, h, l, c, u, p;
                    for (n = arguments[0], t = 2 <= arguments.length ? v.call(arguments, 1) : [], u = this.width === i ? 0 : this.position.x, p = this.height === i ? 0 : this.position.y, c = function() {
                            switch (this.width) {
                                case i:
                        ...
                        }.call(this), o = 0, a = t.length; a > o; o++) e = t[o], e.save(), e.beginPath(), e.rect(u, p, c, r), e.clip();
                    for (n(), l = [], s = 0, h = t.length; h > s; s++) e = t[s], l.push(e.restore());
                    return l
                    ...
                    var e, n, i, o, s, h, l, c, u, p;
                    if (t) {
                        if (t.colors)
                            for (h = ["primary", "secondary", "background"], e = 0, o = h.length; o > e; e++) i = h[e], this.setColor(i, t.colors[i]);
                        if (t.shapes)
                            for (this.shapes = [], l = t.shapes, n = 0, s = l.length; s > n; n++) p = l[n], u = r(p), u && this.execute(new a.AddShapeAction(this, u));
                        return t.backgroundShapes && (this.backgroundShapes = function() { var e, n, i, o; for (i = t.backgroundShapes, o = [], e = 0, n = i.length; n > e; e++) c = i[e], o.push(r(c)); return o }()), t.imageSize && (this.width = t.imageSize.width, this.height = t.imageSize.height), t.position && (this.position = t.position), t.scale && (this.scale = t.scale), this.repaintAllLayers(), this.trigger("snapshotLoad"), this.trigger("drawingChange", {})
                    }
        ...
        7: [function(t, e, n) {
            var i, r;
            r = function() {
                function t(t, e, n) { this.lc = t, this.oldShapes = e, this.newShapes = n }
                return t.prototype["do"] = function() { return this.lc.shapes = this.newShapes, this.lc.repaintLayer("main") }, t.prototype.undo = function() { return this.lc.shapes = this.oldShapes, this.lc.repaintLayer("main") }, t
            }(), i = function() {
                function t(t, e, n) { this.lc = t, this.shape = e, this.previousShapeId = null != n ? n : null }
        ...
        9: [function(t, e, n) {
            ...
            l = t("./lineEndCapShapes"), d = {}, r = function(t, e, n) { return d[t] = { drawFunc: e, drawLatestFunc: n } }, c = function() {}, p = function(t, e, n) { var i; if (null == n && (n = {}), null == n.shouldIgnoreUnsupportedShapes && (n.shouldIgnoreUnsupportedShapes = !1), null == n.retryCallback && (n.retryCallback = c), null == n.shouldOnlyDrawLatest && (n.shouldOnlyDrawLatest = !1), null == n.bufferCtx && (n.bufferCtx = null), i = n.bufferCtx, d[e.className]) return n.shouldOnlyDrawLatest && d[e.className].drawLatestFunc ? d[e.className].drawLatestFunc(t, i, e, n.retryCallback) : d[e.className].drawFunc(t, e, n.retryCallback); if (n.shouldIgnoreUnsupportedShapes) return console.warn("Can't render shape of type " + e.className + " to canvas"); throw "Can't render shape of type " + e.className + " to canvas" }, u = function(t, e, n) { return p(t.getContext("2d"), e, n) }, r("Rectangle", function(t, e) { var n, i; return n = e.x, i = e.y, e.strokeWidth % 2 !== 0 && (n += .5, i += .5), t.fillStyle = e.fillColor, t.fillRect(n, i, e.width, e.height), t.lineWidth = e.strokeWidth, t.strokeStyle = e.strokeColor, t.strokeRect(n, i, e.width, e.height) }), r("Ellipse", function(t, e) { var n, i, r, o; return t.save(), o = Math.floor(e.width / 2), r = Math.floor(e.height / 2), n = e.x + o, i = e.y + r, t.translate(n, i), t.scale(1, Math.abs(e.height / e.width)), t.beginPath(), t.arc(0, 0, Math.abs(o), 0, 2 * Math.PI), t.closePath(), t.restore(), t.fillStyle = e.fillColor, t.fill(), t.lineWidth = e.strokeWidth, t.strokeStyle = e.strokeColor, t.stroke() }), r("SelectionBox", function() {
                var t;
                return t = function(t, e, n) { var i, r; return i = e.x, r = e.y, 0 !== n ? (t.fillStyle = "#fff", t.fillRect(i, r, n, n), t.strokeStyle = "#000", t.strokeRect(i, r, n, n)) : void 0 },
        ...
        11: [function(t, e, n) {
            ...
            ! function() {
                ...
                var t = function(t, e) { return document.defaultView.getComputedStyle(t, null).getPropertyValue(e) };
                CanvasRenderingContext2D.prototype.measureText2 = function(e, n, i) {
                    var r = this.measureTextWidth(e),
                        o = !/\S/.test(e);
                    r.fontsize = n;
                    var s = document.createElement("div");
                    s.style.position = "absolute", s.style.opacity = 0, s.style.font = i, s.innerHTML = e + "<br/>" + e, document.body.appendChild(s), r.leading = 1.2 * n;
                    var a = t(s, "height");
                    if (a = a.replace("px", ""), a >= 2 * n && (r.leading = a / 2 | 0), document.body.removeChild(s), o) r.ascent = 0, r.descent = 0, r.bounds = { minx: 0, maxx: r.width, miny: 0, maxy: 0 }, r.height = 0;
                    else {
                        var h = document.createElement("canvas"),
                            l = 100;
                        h.width = r.width + l, h.height = 3 * n, h.style.opacity = 1, h.style.font = i;
                        var c = h.getContext("2d");
                        c.font = i;
                        var u = h.width,
                            p = h.height,
                            d = p / 2;
                        c.fillStyle = "white", c.fillRect(-1, -1, u + 2, p + 2), c.fillStyle = "black", c.fillText(e, l / 2, d);
                        for (var f = c.getImageData(0, 0, u, p).data, g = 0, m = 4 * u, y = f.length; ++g < y && 255 === f[g];);
                        var S = g / m | 0;
                        for (g = y - 1; --g > 0 && 255 === f[g];);
                        var v = g / m | 0;
                        for (g = 0; y > g && 255 === f[g];) g += m, g >= y && (g = g - y + 4);
                        var x = g % m / 4 | 0,
                            w = 1;
                        for (g = y - 3; g >= 0 && 255 === f[g];) g -= m, 0 > g && (g = y - 3 - 4 * w++);
                        var k = g % m / 4 + 1 | 0;
        ...
        17: [function(t, e, n) {
            ...
            C = t("./util"), o = t("./TextRenderer"), m = t("./lineEndCapShapes"), S = t("./canvasRenderer"), d = S.defineCanvasRenderer, x = S.renderShapeToContext, v = t("./svgRenderer"), f = v.defineSVGRenderer, w = v.renderShapeToSVG, b = {}, g = function(t, e) {
                ...
                for (o = t[0].size, e = t[0].color, r = 0, n = t.length; n > r; r++)
                    if (i = t[r], i.size === o && i.color === e || console.log(o, e, i.size, i.color), i.size !== o || i.color !== e) return !1;
                return !0
                ...
                constructor: function(t) { return null == t && (t = {}), this.x = t.x || 0, this.y = t.y || 0, this.v = t.v || 0, this.text = t.text || "", this.color = t.color || "black", this.font = t.font || "18px sans-serif", this.forcedWidth = t.forcedWidth || null, this.forcedHeight = t.forcedHeight || null },
                _makeRenderer: function(t) { return t.lineHeight = 1.2, this.renderer = new o(t, this.text, this.font, this.forcedWidth, this.forcedHeight), this.v < 1 ? (console.log("repairing baseline"), this.v = 1, this.x -= this.renderer.metrics.bounds.minx, this.y -= this.renderer.metrics.leading - this.renderer.metrics.descent) : void 0 },
                setText: function(t) { return this.text = t, this.renderer = null },
                setFont: function(t) { return this.font = t, this.renderer = null },
                setPosition: function(t, e) { return this.x = t, this.y = e },
                setSize: function(t, e) { return this.forcedWidth = Math.max(t, 0), this.forcedHeight = Math.max(e, 0), this.renderer = null },
                enforceMaxBoundingRect: function(t) { var e, n, i; return e = this.getBoundingRect(t.ctx), i = { x: -t.position.x / t.scale, y: -t.position.y / t.scale, width: t.canvas.width / t.scale, height: t.canvas.height / t.scale }, e.x + e.width > i.x + i.width ? (n = e.x - i.x, this.forcedWidth = i.width - n - 10, this.renderer = null) : void 0 },
                ...
                toJSON: function() { return { x: this.x, y: this.y, text: this.text, color: this.color, font: this.font, forcedWidth: this.forcedWidth, forcedHeight: this.forcedHeight, v: this.v } },
                fromJSON: function(t) { return p("Text", t) },
                move: function(t) { return null == t && (t = {}), this.x = this.x - t.xDiff, this.y = this.y - t.yDiff },
                setUpperLeft: function(t) { return null == t && (t = {}), this.x = t.x, this.y = t.y }
        ...
        19: [function(t, e, n) {
            ...
            o = Array.prototype.slice, i = t("./canvasRenderer").renderShapeToContext, r = t("./svgRenderer").renderShapeToSVG, s = {
                addImageOnload: function(t, e) { var n; return n = t.onload, t.onload = function() { return "function" == typeof n && n(), e() }, t },
                last: function(t, e) { return null == e && (e = null), e ? o.call(t, Math.max(t.length - e, 0)) : t[t.length - 1] },
                classSet: function(t) {
                    var e, n;
                    e = [];
                    for (n in t) t[n] && e.push(n);
                    return e.join(" ")
                },
                matchElementSize: function(t, e, n, i) { var r; return null == i && (i = function() {}), r = function(r) { return function() { var r, o, s; for (o = 0, s = e.length; s > o; o++) r = e[o], r.style.width = t.offsetWidth + "px", r.style.height = t.offsetHeight + "px", null != r.width && (r.setAttribute("width", r.offsetWidth * n), r.setAttribute("height", r.offsetHeight * n)); return i() } }(this), t.addEventListener("resize", r), window.addEventListener("resize", r), window.addEventListener("orientationchange", r), r(), r },
                combineCanvases: function() { var t, e, n, i, r, o, s, h; for (n = 1 <= arguments.length ? a.call(arguments, 0) : [], t = document.createElement("canvas"), t.width = n[0].width, t.height = n[0].height, r = 0, s = n.length; s > r; r++) e = n[r], t.width = Math.max(e.width, t.width), t.height = Math.max(e.height, t.height); for (i = t.getContext("2d"), o = 0, h = n.length; h > o; o++) e = n[o], i.drawImage(e, 0, 0); return t },
                renderShapes: function(t, e, n, r) { var o, s, a, h; for (null == n && (n = 1), null == r && (r = null), r = r || document.createElement("canvas"), r.width = e.width * n, r.height = e.height * n, o = r.getContext("2d"), o.translate(-e.x * n, -e.y * n), o.scale(n, n), s = 0, a = t.length; a > s; s++) h = t[s], i(o, h); return r },
                renderShapesToSVG: function(t, e, n) { var i, o, s, a; return s = e.x, a = e.y, o = e.width, i = e.height, ("<svg xmlns='http://www.w3.org/2000/svg' width='" + o + "' height='" + i + "' viewBox='0 0 " + o + " " + i + "'> <rect width='" + o + "' height='" + i + "' x='0' y='0' fill='" + n + "' /> <g transform='translate(" + -s + ", " + -a + ")'> " + t.map(r).join("") + " </g> </svg>").replace(/(\r\n|\n|\r)/gm, "") },
                getBoundingRect: function(t, e, n) { var i, r, o, s, a, h, l; if (!t.length) return { x: 0, y: 0, width: e, height: n }; for (a = t[0].x, h = t[0].y, o = t[0].x + t[0].width, s = t[0].y + t[0].height, i = 0, r = t.length; r > i; i++) l = t[i], a = Math.floor(Math.min(l.x, a)), h = Math.floor(Math.min(l.y, h)), o = Math.ceil(Math.max(o, l.x + l.width)), s = Math.ceil(Math.max(s, l.y + l.height)); return a = e ? 0 : a, h = n ? 0 : h, o = e || o, s = n || s, { x: a, y: h, width: o - a, height: s - h } },
                getDefaultImageRect: function(t, e, n) { var i, r, o; return null == e && (e = { width: 0, height: 0 }), null == n && (n = { top: 0, right: 0, bottom: 0, left: 0 }), o = e.width, i = e.height, r = s.getBoundingRect(t, "infinite" === o ? 0 : o, "infinite" === i ? 0 : i), r.x -= n.left, r.y -= n.top, r.width += n.left + n.right, r.height += n.top + n.bottom, r },
                getBackingScale: function(t) { return null == window.devicePixelRatio ? 1 : window.devicePixelRatio > 1 ? window.devicePixelRatio : 1 },
                requestAnimationFrame: (window.requestAnimationFrame || window.setTimeout).bind(window),
                getGUID: function() {
                    var t;
                    return t = function() { return Math.floor(65536 * (1 + Math.random())).toString(16).substring(1) },
                        function() { return t() + t() + "-" + t() + "-" + t() + "-" + t() + "-" + t() + t() + t() }
                }(),
                requestAnimationFrame: function(t) { return window.requestAnimationFrame ? window.requestAnimationFrame(t) : window.webkitRequestAnimationFrame ? window.webkitRequestAnimationFrame(t) : window.mozRequestAnimationFrame ? window.mozRequestAnimationFrame(t) : setTimeout(t, 0) },
                cancelAnimationFrame: function(t) { return window.cancelAnimationFrame ? window.cancelAnimationFrame(t) : window.webkitCancelRequestAnimationFrame ? window.webkitCancelRequestAnimationFrame(t) : window.webkitCancelAnimationFrame ? window.webkitCancelAnimationFrame(t) : window.mozCancelAnimationFrame ? window.mozCancelAnimationFrame(t) : clearTimeout(t) }
            }, e.exports = s
        ...
        22: [function(t, e, n) {
            ...
            t("./ie_customevent"), t("./ie_setLineDash"), i = t("./core/LiterallyCanvas"), l = t("./core/defaultOptions"), s = t("./core/canvasRenderer"), w = t("./core/svgRenderer"), x = t("./core/shapes"), b = t("./core/util"), y = t("./core/renderSnapshotToImage"), S = t("./core/renderSnapshotToSVG"), g = t("./core/localization").localize, r = t("./reactGUI/LiterallyCanvas"), d = t("./reactGUI/initDOM"), t("./optionsStyles/font"), t("./optionsStyles/stroke-width"), t("./optionsStyles/line-options-and-stroke-width"), t("./optionsStyles/polygon-and-stroke-width"), t("./optionsStyles/stroke-or-fill"), t("./optionsStyles/null"), u = t("./optionsStyles/optionsStyles").defineOptionsStyle, a = { snapshotToShapes: function(t) { var e, n, i, r, o; for (i = t.shapes, r = [], e = 0, n = i.length; n > e; e++) o = i[e], r.push(x.JSONToShape(o)); return r }, snapshotJSONToShapes: function(t) { return a.snapshotToShapes(JSON.parse(t)) } }, o = t("./tools/base"), k = { Pencil: t("./tools/Pencil"), Eraser: t("./tools/Eraser"), Line: t("./tools/Line"), Rectangle: t("./tools/Rectangle"), Ellipse: t("./tools/Ellipse"), Text: t("./tools/Text"), Polygon: t("./tools/Polygon"), Pan: t("./tools/Pan"), Eyedropper: t("./tools/Eyedropper"), SelectShape: t("./tools/SelectShape"), Tool: o.Tool, ToolWithStroke: o.ToolWithStroke }, c = l.tools, h = l.imageURLPrefix, v = function(t) { return h = t, l.imageURLPrefix = t }, p = function(e, n) {
                ...
                for (a = e.children, r = 0, o = a.length; o > r; r++) i = a[r], e.removeChild(i);
                return t("./reactGUI/initDOM")(e, n)
        ...
        23: [function(t, e, n) {
            var i, r, o, s, a, h, l, c, u, p, d, f, g, m, y, S, v, x, w, k, b, C, P;
            for (a = t("../reactGUI/React-shim"), u = t("./optionsStyles").defineOptionsStyle, c = t("../core/localization")._, h = [
                    ...
                    [c("Monospace"), o],
                    [c("Other"), s]
                ], r = {}, p = 0, g = h.length; g > p; p++) w = h[p], x = w.name, P = w.value, r[x] = P;
            for (d = 0, m = l.length; m > d; d++) k = l[d], x = k.name, P = k.value, r[x] = P;
            for (f = 0, y = o.length; y > f; f++) b = o[f], x = b.name, P = b.value, r[x] = P;
            for (v = 0, S = s.length; S > v; v++) C = s[v], x = C.name, P = C.value, r[x] = P;
            u("font", a.createClass({
                displayName: "FontOptions",
                getInitialState: function() { return { isItalic: !1, isBold: !1, fontName: "Helvetica", fontSizeIndex: 4 } },
                getFontSizes: function() { return [9, 10, 12, 14, 18, 24, 36, 48, 64, 72, 96, 144, 288] },
                updateTool: function(t) {
                    var e, n, i;
                    null == t && (t = {});
                    for (i in this.state) i in t || (t[i] = this.state[i]);
                    return e = this.getFontSizes()[t.fontSizeIndex], n = [], t.isItalic && n.push("italic"), t.isBold && n.push("bold"), n.push(e + "px"), n.push(r[t.fontName]), this.props.lc.tool.font = n.join(" "), this.props.lc.trigger("setFont", n.join(" "))
                },
                handleFontSize: function(t) { var e; return e = { fontSizeIndex: t.target.value }, this.setState(e), this.updateTool(e) },
                handleFontFamily: function(t) { var e; return e = { fontName: t.target.selectedOptions[0].innerHTML }, this.setState(e), this.updateTool(e) },
                handleItalic: function(t) { var e; return e = { isItalic: !this.state.isItalic }, this.setState(e), this.updateTool(e) },
                handleBold: function(t) { var e; return e = { isBold: !this.state.isBold }, this.setState(e), this.updateTool(e) },
                componentDidMount: function() { return this.updateTool() },
                render: function() { var t, e, n, r, o, s, h, l, u, p; return o = this.props.lc, l = a.DOM, e = l.div, n = l.input, u = l.select, h = l.option, t = l.br, r = l.label, p = l.span, s = l.optgroup, e({ className: "lc-font-settings" }, u({ value: this.state.fontSizeIndex, onChange: this.handleFontSize }, this.getFontSizes().map(function(t) { return function(t, e) { return h({ value: e, key: e }, t + "px") } }(this))), u({ value: this.state.fontName, onChange: this.handleFontFamily }, i.map(function(t) { return function(t) { var e, n; return n = t[0], e = t[1], s({ key: n, label: n }, e.map(function(t, e) { return h({ value: t.name, key: e }, t.name) })) } }(this))), p({}, r({ htmlFor: "italic" }, c("italic")), n({ type: "checkbox", id: "italic", checked: this.state.isItalic, onChange: this.handleItalic })), p({}, r({ htmlFor: "bold" }, c("bold")), n({ type: "checkbox", id: "bold", checked: this.state.isBold, onChange: this.handleBold }))) }
            })), e.exports = {}
        ...
        32: [function(t, e, n) {
            ...
            t("../optionsStyles/font"), t("../optionsStyles/stroke-width"), t("../optionsStyles/line-options-and-stroke-width"), t("../optionsStyles/polygon-and-stroke-width"), t("../optionsStyles/null");
            var d = i.createClass({ displayName: "CanvasContainer", shouldComponentUpdate: function() { return !1 }, render: function() { return i.createElement("div", { key: "literallycanvas", className: "lc-drawing with-gui" }) } }),
                f = i.createClass({
                    displayName: "LiterallyCanvas",
                    getDefaultProps: function() { return p },
                    ...
                    componentDidMount: function() { this.lc.isBound || this.bindToModel() },
                    componentWillUnmount: function() { this.lc && this.lc._teardown() },
                    render: function() {
                        var t = this,
                            e = this.lc,
                            ...
                            u = a({ "toolbar-at-top": "top" === s, "toolbar-at-bottom": "bottom" === s, "toolbar-hidden": "hidden" === s });
                        return i.createElement("div", { className: "literally " + u }, i.createElement(d, { ref: function(e) { return t.canvas = e } }), i.createElement(h, c), i.createElement(l, { lc: e, imageURLPrefix: o }))
                    }
                });
            e.exports = f
        ...
        35: [function(t, e, n) {
            var i;
            try { i = t("react") } catch (r) { i = window.React }
            if (null == i) throw "Can't find React";
            e.exports = i
        }, { react: "react" }],
        36: [function(t, e, n) {
            var i;
            try { i = t("react-dom") } catch (r) { i = window.ReactDOM }
            if (null == i) try { i = t("react") } catch (o) { i = window.React }
        ...
        38: [function(t, e, n) {
            ...
            i = t("./React-shim"), h = t("./createSetStateOnEventMixin"), a = t("../core/util").classSet, l = function(t) {
                return i.createClass({
                    displayName: "undo" === t ? "UndoButton" : "RedoButton",
                    getState: function() {
                        return {
                            isEnabled: function() {
                                switch (!1) {
                    ...
                    render: function() {
                        var e, n, r, o, s, h, l, c, u, p, d;
                        return l = i.DOM, n = l.div, o = l.img, c = this.props, s = c.lc, r = c.imageURLPrefix, d = "undo" === t ? "Undo" : "Redo", e = "lc-" + t + " " + a({ "toolbar-button": !0, "thin-button": !0, disabled: !this.state.isEnabled }), h = function() {
                            switch (!1) {
        ...
        39: [function(t, e, n) {
            ...
            i = t("./React-shim"), h = t("./createSetStateOnEventMixin"), a = t("../core/util").classSet, l = function(t) {
                return i.createClass({
                    displayName: "in" === t ? "ZoomInButton" : "ZoomOutButton",
                    getState: function() {
                        return {
                            isEnabled: function() {
                                switch (!1) {
                    ...
                    render: function() {
                        var e, n, r, o, s, h, l, c, u, p, d;
                        return l = i.DOM, n = l.div, o = l.img, c = this.props, s = c.lc, r = c.imageURLPrefix, d = "in" === t ? "Zoom in" : "Zoom out", e = "lc-zoom-" + t + " " + a({ "toolbar-button": !0, "thin-button": !0, disabled: !this.state.isEnabled }), h = function() {
                            switch (!1) {
                                case !!this.state.isEnabled:
                                    return function() {};
                                case "in" !== t:
        ...
        42: [function(t, e, n) {
            ...
            function i(t, e) {
                var n = t.className,
                    i = new s(e);
                return o.render(r.createElement(a, { lc: i }), t), i.teardown = function() {
                    i._teardown();
                    for (var e = 0; e < t.children.length; e++) t.removeChild(t.children[e]);
                    t.className = n
                }, i
            }
            var r = t("./React-shim"),
        ...
        44: [function(t, e, n) {
            ...
            r = t("./Pencil"), o = t("../core/shapes").createShape, e.exports = i = function(t) {
                function e() { return e.__super__.constructor.apply(this, arguments) }
                return s(e, t), e.prototype.name = "Borrador", e.prototype.iconName = "eraser", e.prototype.makePoint = function(t, e, n) { return o("Point", { x: t, y: e, size: this.strokeWidth, color: "#000" }) }, e.prototype.makeShape = function() { return o("ErasedLinePath") }, e
            }(r)
        ...
        45: [function(t, e, n) {
            ...
            r = t("./base").Tool, o = function(t, e) { var n, i, r; return i = e.x, r = e.y, n = t.getImageData(i, r, 1, 1).data, n[3] ? "rgb(" + n[0] + ", " + n[1] + ", " + n[2] + ")" : null }, e.exports = i = function(t) {
                function e(t) { e.__super__.constructor.call(this, t), this.strokeOrFill = "stroke" }
                return s(e, t), e.prototype.name = "Cuentagotas", e.prototype.iconName = "eyedropper", e.prototype.optionsStyle = "stroke-or-fill", e.prototype.readColor = function(t, e, n) { var i, r, s, a; return a = n.getDefaultImageRect(), i = n.getImage(), s = o(i.getContext("2d"), { x: t - a.x, y: e - a.y }), r = s || n.getColor("background"), "stroke" === this.strokeOrFill ? n.setColor("primary", s) : n.setColor("secondary", s) }, e.prototype.begin = function(t, e, n) { return this.readColor(t, e, n) }, e.prototype["continue"] = function(t, e, n) { return this.readColor(t, e, n) }, e
            }(r)
        }, { "./base": 53 }],
        46: [function(t, e, n) {
            var i, r, o, s = function(t, e) {
            ...
            r = t("./base").ToolWithStroke, o = t("../core/shapes").createShape, e.exports = i = function(t) {
                function e() { return e.__super__.constructor.apply(this, arguments) }
                return s(e, t), e.prototype.name = "Linea", e.prototype.iconName = "line", e.prototype.optionsStyle = "line-options-and-stroke-width", e.prototype.begin = function(t, e, n) {
                ...
                return a(e, t), e.prototype.name = "Texto", e.prototype.iconName = "text", e.prototype.didBecomeActive = function(t) { var e, n, i; return n = [], this.unsubscribe = function(t) { return function() { var t, e, i, r; for (r = [], e = 0, i = n.length; i > e; e++) t = n[e], r.push(t()); return r } }(this), e = function(e) { return function() { return e._ensureNotEditing(t), e._clearCurrentShape(t), t.repaintLayer("main") } }(this), i = function(e) { return function() { return e._updateInputEl(t) } }(this), n.push(t.on("drawingChange", e)), n.push(t.on("zoom", i)), n.push(t.on("imageSizeChange", i)), n.push(t.on("snapshotLoad", function(e) { return function() { return e._clearCurrentShape(t), t.repaintLayer("main") } }(this))), n.push(t.on("primaryColorChange", function(e) { return function(n) { return e.currentShape ? (e.currentShape.color = n, e._updateInputEl(t), t.repaintLayer("main")) : void 0 } }(this))), n.push(t.on("setFont", function(e) { return function(n) { return e.currentShape ? (e.font = n, e.currentShape.setFont(n), e._setShapesInProgress(t), e._updateInputEl(t), t.repaintLayer("main")) : void 0 } }(this))) }, e.prototype.willBecomeInactive = function(t) { return this.currentShape && (this._ensureNotEditing(t), this.commit(t)), this.unsubscribe() }, e.prototype.setText = function(t) { return this.text = t }, e.prototype._ensureNotEditing = function(t) { return "editing" === this.currentShapeState ? this._exitEditingState(t) : void 0 }, e.prototype._clearCurrentShape = function(t) { return this.currentShape = null, this.initialShapeBoundingRect = null, this.currentShapeState = null, t.setShapesInProgress([]) }, e.prototype.commit = function(t) { return this.currentShape.text && t.saveShape(this.currentShape), this._clearCurrentShape(t), t.repaintLayer("main") }, e.prototype._getSelectionShape = function(t, e) { return null == e && (e = null), o("SelectionBox", { shape: this.currentShape, ctx: t, backgroundColor: e }) }, e.prototype._setShapesInProgress = function(t) {
                    ...
                    if ("none" !== this.dragAction) {
                        switch (i = this.initialShapeBoundingRect, o = i.x + i.width, r = i.y + i.height, this.dragAction) {
                            case "place":
                                this.currentShape.x = t, this.currentShape.y = e, this.didDrag = !0;
                                break;
                            case "move":
                                this.currentShape.x = t - this.dragOffset.x, this.currentShape.y = e - this.dragOffset.y, this.didDrag = !0;
                                break;
                            case "resizeBottomRight":
                                this.currentShape.setSize(t - (this.dragOffset.x - this.initialShapeBoundingRect.width) - i.x, e - (this.dragOffset.y - this.initialShapeBoundingRect.height) - i.y);
                                break;
                            case "resizeTopLeft":
                                this.currentShape.setSize(o - t + this.dragOffset.x, r - e + this.dragOffset.y), this.currentShape.setPosition(t - this.dragOffset.x, e - this.dragOffset.y);
                                break;
                            case "resizeBottomLeft":
                                this.currentShape.setSize(o - t + this.dragOffset.x, e - (this.dragOffset.y - this.initialShapeBoundingRect.height) - i.y), this.currentShape.setPosition(t - this.dragOffset.x, this.currentShape.y);
                                break;
                            case "resizeTopRight":
        ...
        53: [function(t, e, n) {
            ...
            o = {}, o.Tool = i = function() {
                function t() {}
                return t.prototype.name = null, t.prototype.iconName = null, t.prototype.usesSimpleAPI = !0, t.prototype.begin = function(t, e, n) {}, t.prototype["continue"] = function(t, e, n) {}, t.prototype.end = function(t, e, n) {}, t.prototype.optionsStyle = null, t.prototype.didBecomeActive = function(t) {}, t.prototype.willBecomeInactive = function(t) {}, t
            }(), o.ToolWithStroke = r = function(t) {
                function e(t) { this.strokeWidth = t.opts.defaultStrokeWidth }
                return s(e, t), e.prototype.optionsStyle = "stroke-width", e.prototype.didBecomeActive = function(t) { var e; return e = [], this.unsubscribe = function(t) { return function() { var t, n, i, r; for (r = [], n = 0, i = e.length; i > n; n++) t = e[n], r.push(t()); return r } }(this), e.push(t.on("setStrokeWidth", function(e) { return function(n) { return e.strokeWidth = n, t.trigger("toolDidUpdateOptions") } }(this))) }, e.prototype.willBecomeInactive = function(t) { return this.unsubscribe() }, e
            }(i), e.exports = o
        }, {}]
    }, {}, [22])(22)
});
