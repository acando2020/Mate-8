  function Inicio() {
    ...
    for(var i=0; i<=5; i++){
      ...
      $("#texto3").append('<br><select id="respuesta3"><option>Seleccione una Respuestas</option><option>No hay solución en ℤ</option>'+array+'</select>');
      $("#texto4").append('<br><select id="respuesta4"><option>Seleccione una Respuestas</option><option>No hay solución en ℤ</option>'+array+'</select>');
      $("#texto5").append('<br><select id="respuesta5"><option>Seleccione una Respuestas</option><option>No hay solución en ℤ</option>'+array+'</select>');
      $("#texto6").append('<br><select id="respuesta6"><option>Seleccione una Respuestas</option><option>No hay solución en ℤ</option>'+array+'</select>');
      };
