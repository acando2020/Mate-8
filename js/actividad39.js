  function Inicio() {
    ...
    for(var i=0; i<=6; i++){
      if(i%2==0)
      $("#contenido1").append('<br>|<label id="valorA'+i+'">'+valoresA[i]+'</label>|&nbsp;=&nbsp;<input type="number"  style="text-align: center;width:50px;height:20px; font-size: 12px" id="res'+i+'"><br>');
      else
      $("#contenido").append('<br>|-(<label id="valorA'+i+'">'+valoresA[i]+'</label>)|&nbsp;=&nbsp;<input type="number"  style="text-align: center;width:50px;height:20px; font-size: 12px" id="res'+i+'"><br>');
